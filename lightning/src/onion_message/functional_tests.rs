...
impl PosNotificationHandler for TestPosNotificationMessageHandler {
	...
	fn handle_payment_ack(&self, _message: PaymentAck) {}

	fn handle_payment_nack(&self, _message: PaymentNack) {}
}
