...
fn creates_and_verifies_payer_proof_after_offer_payment() {
	...
	assert_eq!(payer_proof.payer_signing_pubkey(), invoice.payer_signing_pubkey());
	...
	assert_eq!(decoded.payment_preimage(), payer_proof.payment_preimage());
	assert_eq!(decoded.payment_hash(), payer_proof.payment_hash());
	assert_eq!(decoded.payer_signing_pubkey(), payer_proof.payer_signing_pubkey());
...
fn creates_payer_proof_with_note_and_selective_disclosure() {
	...
	assert_eq!(minimal_payer_proof.payment_preimage(), payer_proof_with_note.payment_preimage());
	assert_eq!(minimal_payer_proof.payment_hash(), payer_proof_with_note.payment_hash());
	assert_eq!(minimal_payer_proof.payer_signing_pubkey(), payer_proof_with_note.payer_signing_pubkey());
