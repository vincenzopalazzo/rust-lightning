...
//!    `OptionalOfferPaymentParams::contact_secrets` together with a return path: either
//!    `OptionalOfferPaymentParams::payer_offer` or `OptionalOfferPaymentParams::payer_bip_353`.
//! 3. The recipient finds the received secret and offer in
//!    [`PayerFields::contact_secret`] and [`PayerFields::payer_offer`] when
...
//! [`PayerFields::payer_offer`]: crate::offers::invoice_request::PayerFields::payer_offer
...
/// recipient's known contacts, returned by [`PayerFields::payer_contact`].
///
/// [`PayerFields::payer_contact`]: crate::offers::invoice_request::PayerFields::payer_contact
#[derive(Clone, Debug, PartialEq, Eq)]
